    ...
    <footer>
      <div class="container">
          <div class="nest">
              <h1>Find Me On</h1>
              <p>
                <a href="https://www.facebook.com/becausejulia/" target="_blank" class="text-light" name="facebook" rel="noreferrer"><svg class="icon icon-facebook2"><use xlink:href="#icon-facebook2"></use></svg></a>
