        ...
        <div class="container marketing">
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <p><a class="btn btn-primary" href="https://www.becausejulia.com/newsletter.php" role="button">View Project &raquo;</a></p>
              </div><!-- /.col-lg-4 -->
              ...
              <div class="col-lg-4">
                ...
                <p><a class="btn btn-primary" href="https://www.becausejulia.com/video.php" role="button">Get the Details &raquo;</a></p>
              </div><!-- /.col-lg-4 -->
              ...
              <div class="col-lg-4">
                ...
                <p><a class="btn btn-primary" href="https://www.becausejulia.com/speed.php" role="button">See it in Action &raquo;</a></p>
              </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
